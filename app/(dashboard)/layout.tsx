...
export default function DashboardLayout({
  ...
  const menuItems = [
    { href: "/dashboard", label: dict.dashboard.sidebar.dashboard, adminOnly: false,
    ...
    { href: "/robots", label: dict.dashboard.sidebar.robots, adminOnly: false,
    ...
    { href: "/robots/manage", label: dict.dashboard.sidebar.manage_robots, adminOnly: true,
    ...
    { href: "/robots/maps", label: dict.dashboard.sidebar.manage_maps, adminOnly: true,
    ...
    { href: "/notifications", label: dict.dashboard.sidebar.notifications, adminOnly: false,
